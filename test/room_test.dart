...
void main() {
  ...
  group('Room', () {
    ...
    test('PowerLevels', () async {
      ...
      expect(room.getPowerLevelByUserId(sdn.userID!), room.ownPowerLevel);
    ...
    test('sendEvent', () async {
      ...
      expect(resp?.startsWith('\$event'), true);
      final entry = FakeSDNApi.calledEndpoints.entries
    ...
    test('send reply', () async {
      ...
      expect(resp?.startsWith('\$event'), true);
      var entry = FakeSDNApi.calledEndpoints.entries
          .firstWhere((p) => p.key.contains('/send/m.room.message/'));
      ...
      expect(content, {
        ...
        'formatted_body':
            '<mx-reply><blockquote><a href="https://sdn.to/#/!localpart:server.abc/\$replyEvent">In reply to</a> <a href="https://sdn.to/#/@alice:example.org">@alice:example.org</a><br>Blah</blockquote></mx-reply>Hello world',
        'm.relates_to': {
          'm.in_reply_to': {
            'event_id': '\$replyEvent',
          },
      ...
      resp = await room.sendTextEvent('Hello world\nfox',
          txid: 'testtxid', inReplyTo: event);
      expect(resp?.startsWith('\$event'), true);
      entry = FakeSDNApi.calledEndpoints.entries
          .firstWhere((p) => p.key.contains('/send/m.room.message/'));
      ...
      expect(content, {
        ...
        'format': 'org.sdn.custom.html',
        'formatted_body':
            '<mx-reply><blockquote><a href="https://sdn.to/#/!localpart:server.abc/\$replyEvent">In reply to</a> <a href="https://sdn.to/#/@alice:example.org">@alice:example.org</a><br>&lt;b&gt;Blah&lt;&#47;b&gt;<br>beep</blockquote></mx-reply>Hello world<br>fox',
        'm.relates_to': {
          'm.in_reply_to': {
            'event_id': '\$replyEvent',
          },
      ...
      expect(content, {
        ...
        'format': 'org.sdn.custom.html',
        'formatted_body':
            '<mx-reply><blockquote><a href="https://sdn.to/#/!localpart:server.abc/\$replyEvent">In reply to</a> <a href="https://sdn.to/#/@alice:example.org">@alice:example.org</a><br>meow</blockquote></mx-reply>Hello world',
        'm.relates_to': {
          'm.in_reply_to': {
            'event_id': '\$replyEvent',
          },
      ...
      expect(content, {
        ...
        'format': 'org.sdn.custom.html',
        'formatted_body':
            '<mx-reply><blockquote><a href="https://sdn.to/#/!localpart:server.abc/\$replyEvent">In reply to</a> <a href="https://sdn.to/#/@alice:example.org">@alice:example.org</a><br>Hey @room</blockquote></mx-reply>Hello world',
        'm.relates_to': {
          'm.in_reply_to': {
            'event_id': '\$replyEvent',
          },
      ...
      event = Event.fromJson({
        ...
        'content': {
          ...
          'format': 'org.sdn.custom.html',
          'formatted_body':
              '<mx-reply><blockquote><a href="https://sdn.to/#/!localpart:server.abc/\$replyEvent">In reply to</a> <a href="https://sdn.to/#/@alice:example.org">@alice:example.org</a><br>Hey</blockquote></mx-reply>Hello world',
          'm.relates_to': {
            'm.in_reply_to': {
              'event_id': '\$replyEvent',
            },
      ...
      expect(content, {
        ...
        'format': 'org.sdn.custom.html',
        'formatted_body':
            '<mx-reply><blockquote><a href="https://sdn.to/#/!localpart:server.abc/\$replyEvent">In reply to</a> <a href="https://sdn.to/#/@alice:example.org">@alice:example.org</a><br>Hello world</blockquote></mx-reply>Fox',
        'm.relates_to': {
          'm.in_reply_to': {
            'event_id': '\$replyEvent',
          },
    ...
    test('pushRuleState', () async {
      ...
      ((sdn.accountData['m.push_rules']?.content['global']
              as Map<String, Object?>)['override'] as List)
          .add(((sdn.accountData['m.push_rules']?.content['global']
    ...
    test('Widgets', () {
      ...
      room.states['m.widget'] = {
        'test': Event.fromJson({
          'content': {
            'creatorUserId': '@rxl881:sdn.org',
            'data': {'title': 'Bridges Dashboard', 'dateRange': '1y'},
            'id': 'grafana_@rxl881:sdn.org_1514573757015',
            'name': 'Grafana',
            'type': 'm.grafana',
            'url': 'https://sdn.org/grafana/whatever',
            'waitForIframeLoad': true
          },
          'room_id': '!foo:bar',
          'event_id': '\$15104760642668662QICBu:sdn.org',
          'sender': '@rxl881:sdn.org',
          'state_key': 'test',
          'origin_server_ts': 1432735824653,
          'type': 'm.widget'
        }, room),
      ...
      room.states['m.widget'] = {
        'test2': Event.fromJson({
          'content': {
            'creatorUserId': '@rxl881:sdn.org',
            'data': {'title': 'Bridges Dashboard', 'dateRange': '1y'},
            'id': 'grafana_@rxl881:sdn.org_1514573757016',
            'type': 'm.grafana',
            'url': 'https://sdn.org/grafana/whatever',
            'waitForIframeLoad': true
          },
          'room_id': '!foo:bar',
          'event_id': '\$15104760642668663QICBu:sdn.org',
          'sender': '@rxl881:sdn.org',
          'state_key': 'test2',
          'origin_server_ts': 1432735824653,
          'type': 'm.widget'
    ...
    test('inviteLink', () async {
      var sdnToLink = await room.sdnToInviteLink();
      expect(
          sdnToLink.toString(), 'https://sdn.to/#/%23testalias%3Aexample.com');
      room.setState(
        Event(
            senderId: '@test:example.com',
            type: 'm.room.canonical_alias',
      ...
      sdnToLink = await room.sdnToInviteLink();
      expect(sdnToLink.toString(),
          'https://sdn.to/#/!localpart%3Aserver.abc?via=example.org&via=example.com&via=test.abc');
    });

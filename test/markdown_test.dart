  ...
  group('markdown', () {
    ...
    test('pills', () {
      expect(markdown('Hey @sorunome:sorunome.de!'),
          'Hey <a href="https://sdn.to/#/@sorunome:sorunome.de">@sorunome:sorunome.de</a>!');
      expect(markdown('#fox:sorunome.de: you all are awesome'),
          '<a href="https://sdn.to/#/#fox:sorunome.de">#fox:sorunome.de</a>: you all are awesome');
      expect(markdown('!blah:example.org'),
          '<a href="https://sdn.to/#/!blah:example.org">!blah:example.org</a>');
      expect(markdown('https://sdn.to/#/#fox:sorunome.de'),
          'https://sdn.to/#/#fox:sorunome.de');
      expect(markdown('Hey @sorunome:sorunome.de:1234!'),
          'Hey <a href="https://sdn.to/#/@sorunome:sorunome.de:1234">@sorunome:sorunome.de:1234</a>!');
      expect(markdown('Hey @sorunome:127.0.0.1!'),
          'Hey <a href="https://sdn.to/#/@sorunome:127.0.0.1">@sorunome:127.0.0.1</a>!');
      expect(markdown('Hey @sorunome:[::1]!'),
          'Hey <a href="https://sdn.to/#/@sorunome:[::1]">@sorunome:[::1]</a>!');
    });
    test('mentions', () {
      expect(markdown('Hey @Bob!', getMention: getMention),
          'Hey <a href="https://sdn.to/#/@bob:example.org">@Bob</a>!');
      expect(markdown('How is @[Bob Ross] doing?', getMention: getMention),
          'How is <a href="https://sdn.to/#/@bobross:example.org">@[Bob Ross]</a> doing?');
      expect(
          markdown('Hey @invalid!', getMention: getMention), 'Hey @invalid!');
      expect(markdown('Hey @Fox#123!', getMention: getMention),
          'Hey <a href="https://sdn.to/#/@fox:example.org">@Fox#123</a>!');
      expect(markdown('Hey @[Fast Fox]#123!', getMention: getMention),
          'Hey <a href="https://sdn.to/#/@fastfox:example.org">@[Fast Fox]#123</a>!');
      expect(markdown('Hey @[">]!', getMention: getMention),
          'Hey <a href="https://sdn.to/#/@blah:example.org">@[&quot;&gt;]</a>!');
    });
    test('latex', () {

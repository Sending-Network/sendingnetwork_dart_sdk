...
class Room {
  ...
  /// This method requires a localization class which implements [SDNLocalizations]
  ...
  /// Call the SDN API to change the name of this room. Returns the event ID of the
  ...
  /// this works if there is no connection to the node. This does **not**
  /// set a read marker!
  ...
  final Map<String, SDNFile> sendingFilePlaceholders = {};
  final Map<String, SDNImageFile> sendingFileThumbnails = {};
  ...
  ///
  /// In case [file] is a [SDNImageFile], [thumbnail] is automatically
  ...
  /// Call the SDN API to join this room if the user is not already a member.
  ...
  /// Call the SDN API to leave this room. If this room is set as a direct
  ...
  final Set<String> _requestingSDNIds = {};
  ...
  /// if returned value is not null `org.sdn.msc3401.call.member` is present
  ...
  /// sets the `org.sdn.msc3401.call.member` power level to users default for
  ...
  /// Sends a request to the node to set the [PushRuleState] for this room.

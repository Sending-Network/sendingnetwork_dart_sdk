...
class Event extends SDNEvent {
  ...
  SDNEvent? _originalSource;

  SDNEvent? get originalSource => _originalSource;
  ...
  factory Event.fromSDNEvent(
    ...
    EventStatus status = defaultStatus,
      ...
      Event(
        status: status,
        content: sdnEvent.content,
        type: sdnEvent.type,
        eventId: sdnEvent.eventId,
        senderId: sdnEvent.senderId,
        originServerTs: sdnEvent.originServerTs,
        unsigned: sdnEvent.unsigned,
        prevContent: sdnEvent.prevContent,
        stateKey: sdnEvent.stateKey,
        room: room,
      );
  ...
  String getLocalizedBody(SDNLocalizations i18n,
          {bool withSenderNamePrefix = false,
          bool hideReply = false,
          bool hideEdit = false,
          bool plaintextBody = false,

...
void main() async {
  ...
  group('Key Verification', () {
    ...
    setUp(() async {
      ...
      client2 = Client(
        'othertestclient',
        httpClient: FakeSDNApi.currentApi!,
        databaseBuilder: getDatabase,
      );
      await client2.checkNode(Uri.parse('https://fakeserver.notexisting'),
          checkWellKnown: false);
      await client2.init(
        newToken: 'abc',
        newUserID: '@othertest:fakeServer.notExisting',
        newNode: client2.node,
    ...
    test('Run emoji / number verification', () async {
      ...
      await FakeSDNApi.firstWhere((e) => e.startsWith(

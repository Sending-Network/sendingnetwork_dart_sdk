...
class SimpleSignableKey extends SDNSignableKey {
  @override
  String? identifier;
...
abstract class SignableKey extends SDNSignableKey {
  Client client;
...
class CrossSigningKey extends SignableKey {
  ...
  CrossSigningKey.fromSDNCrossSigningKey(SDNCrossSigningKey key, Client client)
...
class DeviceKeys extends SignableKey {
  ...
  DeviceKeys.fromSDNDeviceKeys(SDNDeviceKeys keys, Client client,

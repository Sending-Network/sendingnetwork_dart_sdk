...
void main() {
  group('Commands', () {
    ...
    Map<String, dynamic> getLastMessagePayload(
      ...
      return json.decode(FakeSDNApi.calledEndpoints.entries
    ...
    test('thread_image', () async {
      FakeSDNApi.calledEndpoints.clear();
      final testImage = SDNFile(bytes: Uint8List(0), name: 'file.jpeg');
    ...
    test('thread_reply', () async {
      ...
      expect(sent, {
        ...
        'format': 'org.sdn.custom.html',
        'formatted_body':
            '<mx-reply><blockquote><a href="https://sdn.to/#/!1234:fakeServer.notExisting/\$parent_event">In reply to</a> <a href="https://sdn.to/#/@test:fakeServer.notExisting">@test:fakeServer.notExisting</a><br>reply</blockquote></mx-reply>reply',
        'm.relates_to': {
          'rel_type': 'm.thread',
          'event_id': '\$parent_event',
    ...
    test('join', () async {
      ...
      expect(
          FakeSDNApi.calledEndpoints['/client/v3/join/!newroom%3Aexample.com']
                  ?.first !=
              null,
          true);
    });
    ...
    test('dm', () async {
      ...
      expect(
          json.decode(
              FakeSDNApi.calledEndpoints['/client/v3/createRoom']?.first),
          {
